...
def draft(goal, intent, objects, retrieved):
    ...
    sys = (
        ...
        "SWOT、" + ("机会、" if intent in ("机会探索", "产品分析", "产品选型") else "")
        + "能力雷达、市场地图、时间线、用户口碑、行动建议、来源。\n"
        ...
        "7. 「## 时间线」章节：每个条目用「- 日期：事件」格式，日期建议用「YYYY年M月」或「YYYY」，"
        "例如 - 2023年5月：成立 / - 2024：融资。不要写成「YYYY年M月日」以外的歧义格式。\n"
